        ...
        for line in infile :
            ...
            for h in range(len(tuples)):
                ...
                if user_id in item_vectors[iid] :
                    ...
                    #if math.fabs(r_x_j-b_x_j) > 5 :
                    #print('r_x_j : '+str(r_x_j))
                    #print('b_x : '+str(b_x))
                    #print('b_j : '+str(b_j))
                    #print('b_x_j : '+str(b_x_j))
                    #print('r_x_j-b_x_j : '+str(r_x_j-b_x_j))
                    #print('s_i_j : '+str(s_i_j))
            ...
            #if i==1:
            #    print(str(rating)+' vs '+str(predict_rate))    
            rmse+=((predict_rate-rating)*(predict_rate-rating))
            #rmse+=(math.fabs(predict_rate-rating))
            num_rmse+=1
            
            '''
            if math.fabs(predict_rate-rating)>10000:
                print(str(rating)+' vs '+str(predict_rate))
                print('b_x_i ' + str(b_x_i))
